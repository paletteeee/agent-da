...
class TopologyAttestationTests(unittest.TestCase):
    ...
    def test_fresh_formal_v6_run_nonce_is_pre_registered(self):
        self.assertEqual(
            FORMAL_PROVENANCE_LAUNCH_NONCE_SHA256_BY_RUN.get(
    ...
    def test_fresh_formal_v7_run_nonce_is_pre_registered(self):
        self.assertEqual(
            FORMAL_PROVENANCE_LAUNCH_NONCE_SHA256_BY_RUN.get(
    ...
    def test_fresh_formal_v8_run_nonce_is_pre_registered(self):
        self.assertEqual(
            FORMAL_PROVENANCE_LAUNCH_NONCE_SHA256_BY_RUN.get(
                "8397ddc935dbd81c0e1816e3f0cfd53457a9e0cfbb3070b847cb4e553e5c767e"
            ),
            "808a9dee87006845b7522df51b78a474114b0eca131a19fdf912d4648ca5f961",
        )

    def test_fresh_formal_v9_run_nonce_is_pre_registered(self):
        self.assertEqual(
            FORMAL_PROVENANCE_LAUNCH_NONCE_SHA256_BY_RUN.get(
                "eacadaef09241cf2d1018318166882ebbc30a57070f093fa5adae85b802b0b07"
            ),
            "0b890110478cc7acc4381662ff7696b80835c1ce2dabcdfc6031545002379b36",
        )

    def test_fresh_formal_v10_run_nonce_is_pre_registered(self):
        self.assertEqual(
            FORMAL_PROVENANCE_LAUNCH_NONCE_SHA256_BY_RUN.get(
                "afb5aef37a8d25f84e0eff97cad94c2b541750da8501175d0825e60836cac3ec"
            ),
            "dbceeef6aabbc8d9f621b4cde82656837b8a5966d2d527a57496b52b1252f233",
        )
