...
def _nft_guard_batch(
    ...
    *,
    ...
    return (
        ...
        f"    meta l4proto tcp ip daddr {{ {subnet_set} }} "
        ...
        f"    iifname != {{ {interface_set} }} meta l4proto tcp "
        f"ip daddr {{ {subnet_set} }} "
    ...
    *,
    ...
    if execution_monitor is not None:
        try:
            ...
            failures.append(exc)
    if network_guard is not None and bool(getattr(network_guard, "active", False)):
        try:
