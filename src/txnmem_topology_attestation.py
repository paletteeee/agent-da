...
FORMAL_PROVENANCE_LAUNCH_NONCE_SHA256_BY_RUN: dict[str, str] = {
    ...
    # txnmem-provenance-formal-20260824-v2
    ...
    # Fresh one-time formal registration v8; underlying identity remains private.
    ...
    # Fresh one-time formal registration v9; underlying identity remains private.
    ...
    # Fresh one-time formal registration v10; underlying identity remains private.
